<?php
// /app/integrador/category/main_category.php
...
$ultimaIntegracion = obtenerDatosUltimaIntegracion($link);
?>
...
<div class="container-fluid dashboard-section p-4 my-4">
    ...
    <h2 class="text-dark-blue mb-4">Integrador / Category</h2>
    <p class="lead">Seleccione una importación para migrar sus datos a la tabla de Categorías.</p>
    ...
    <div class="card p-4">
        <div class="row align-items-end">
            ...
            <div class="col-md-4">
                <button id="btnIntegrar" class="btn btn-primary w-100" disabled>
                    <i class="fas fa-cogs me-2"></i>2. Integrar Datos
                </button>
            </div>
        </div>
    ...
    <div id="ultimaIntegracionBox" class="card p-3 mt-4 shadow-sm" style="<?php echo $ultimaIntegracion ? '' : 'display: none;'; ?>">
        <h5 class="card-title text-dark-blue">Última Integración Realizada</h5>
        <?php 
            if ($ultimaIntegracion) {
                $correlativo_usado = $ultimaIntegracion['import_correlativo'];
                $num_registros = contarRegistrosPorCorrelativo($correlativo_usado, $link);
            } else {
                $correlativo_usado = '';
                $num_registros = 0;
            }
        ...
        <div class="d-flex justify-content-between align-items-center">
            ...
            <div class="d-flex gap-2">
                <button id="btnVerDatos" class="btn btn-info" data-correlativo="<?php echo htmlspecialchars($correlativo_usado); ?>">
                    <i class="fas fa-eye me-2"></i>Ver Datos
                </button>
                <button id="btnVaciarCategory" class="btn btn-danger">
