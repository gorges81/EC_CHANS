<?php
// /app/integrador/all/main_all.php
...
$ultimaIntegracion = obtenerDatosUltimaIntegracionAll($link); 
?>
<link rel="stylesheet" href="/ec_chans/css/style_all.css">
...
<div class="container-fluid dashboard-section p-4 my-4">
    ...
    <h2 class="text-dark-blue mb-4">Integrador / All</h2>
    <p class="lead">Seleccione una importación para migrar los datos del archivo "All" a su tabla.</p>
    ...
    <div class="card p-4">
        <div class="row align-items-end">
            ...
            <div class="col-md-4">
                <button id="btnIntegrarAll" class="btn btn-primary w-100" disabled>
                    <i class="fas fa-cogs me-2"></i>2. Integrar Datos de All
                </button>
            </div>
        </div>
    ...
    <?php if ($ultimaIntegracion): 
        ...
        $num_registros = contarRegistrosAllPorCorrelativo($correlativo_usado, $link);
    ?>
    <div id="ultimaIntegracionBox" class="card p-3 mt-4 shadow-sm">
        <h5 class="card-title text-dark-blue">Última Integración Realizada (All)</h5>
        <div class="d-flex justify-content-between align-items-center">
            ...
            <div class="d-flex gap-2">
                <button id="btnVerDatosAll" class="btn btn-info" data-correlativo="<?php echo htmlspecialchars($correlativo_usado); ?>">
                    <i class="fas fa-eye me-2"></i>Ver Datos
                </button>
                <button id="btnVaciarAll" class="btn btn-danger">
...
<script src="/ec_chans/js/script_all.js"></script>