<?php
// /app/integrador/walmart_inv/main_walmart_inv.php
...
$correlativos = obtenerCorrelativosConArchivo($link, 'url_walmart_inv');
$ultimaIntegracion = obtenerDatosUltimaIntegracionWalmartInv($link);
?>
<!-- El resto del código HTML de la vista permanece igual -->
<link rel="stylesheet" href="/ec_chans/css/style_walmart_inv.css">
<div class="container-fluid dashboard-section p-4 my-4">
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active" aria-current="page">Walmart Inventory</li>
        </ol>
    </nav>
    <h2 class="text-dark-blue mb-4">Integrador / Walmart Inventory</h2>
    <p class="lead">Seleccione una importación para migrar los datos del archivo de inventario de Walmart.</p>
    <div class="card p-4 shadow-sm">
        <div class="row align-items-end">
            ...
            <div class="col-md-4">
                <button id="btnIntegrarWalmartInv" class="btn btn-primary w-100" disabled>
    ...
    <?php
        ...
        $num_registros = contarRegistrosWalmartInvPorCorrelativo($correlativo_usado, $link);
    ?>
    <div class="card mt-4 shadow-sm">
        <div class="card-header bg-dark text-white">
            <h5 class="mb-0">Última Integración Realizada (Walmart Inv)</h5>
        </div>
        <div class="card-body">
            <div class="d-flex justify-content-between align-items-center flex-wrap">
                ...
                <div class="d-flex gap-2 mt-2 mt-md-0">
                    <button id="btnVerDatosWalmartInv" class="btn btn-info" data-correlativo="<?php echo htmlspecialchars($correlativo_usado); ?>">
                        <i class="fas fa-eye me-2"></i>Ver Datos
                    </button>
                    <button id="btnVaciarWalmartInv" class="btn btn-danger">
...
<script src="/ec_chans/js/script_walmart_inv.js"></script>
