<?php
// /app/integrador/inv_shopify_ph/obtener_datos_grid_inv_shopify_ph.php
...
if (isset($_POST['correlativo'])) {
    ...
    $datos = obtenerDatosInvShopifyPHporCorrelativo($correlativo, $link);
    ...
    if ($datos !== null) {
        ...
        $response['headers'] = [
            ...
            'hand' => 'Hand', 'option' => 'Option', 'sku' => 'SKU', 
