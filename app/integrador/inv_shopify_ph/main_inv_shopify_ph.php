<?php
// /app/integrador/inv_shopify_ph/main_inv_shopify_ph.php
...
$correlativos = obtenerCorrelativosConArchivo($link, 'url_inv_shopify_ph');
$ultimaIntegracion = obtenerDatosUltimaIntegracionInvShopifyPH($link);
?>
<link rel="stylesheet" href="/ec_chans/css/style_inv_shopify_ph.css">
...
<div class="container-fluid dashboard-section p-4 my-4">
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active" aria-current="page">Inventario Shopify PH</li>
        </ol>
    </nav>
    
    <h2 class="text-dark-blue mb-4">Integrador / Inventario Shopify PH</h2>
    <p class="lead">Seleccione una importación para migrar los datos del archivo de inventario de Shopify.</p>
    ...
    <div class="card p-4 shadow-sm">
        <div class="row align-items-end">
            ...
            <div class="col-md-4">
                <button id="btnIntegrarInvShopifyPH" class="btn btn-primary w-100" disabled>
    ...
    <?php
        ...
        $num_registros = contarRegistrosInvShopifyPHporCorrelativo($correlativo_usado, $link);
    ?>
    <div class="card mt-4 shadow-sm">
        <div class="card-header bg-dark text-white">
            <h5 class="mb-0">Última Integración Realizada (Inv Shopify PH)</h5>
        </div>
        <div class="card-body">
            <div class="d-flex justify-content-between align-items-center flex-wrap">
                ...
                <div class="d-flex gap-2 mt-2 mt-md-0">
                    <button id="btnVerDatosInvShopifyPH" class="btn btn-info" data-correlativo="<?php echo htmlspecialchars($correlativo_usado); ?>">
                        <i class="fas fa-eye me-2"></i>Ver Datos
                    </button>
                    <button id="btnVaciarInvShopifyPH" class="btn btn-danger">
...
<script src="/ec_chans/js/script_inv_shopify_ph.js"></script>