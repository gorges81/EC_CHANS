<?php
// /app/integrador/ebay/main_ebay.php
...
$correlativos = obtenerCorrelativosConArchivo($link, 'url_ebay');
$ultimaIntegracion = obtenerDatosUltimaIntegracionEbay($link);
?>
<link rel="stylesheet" href="/ec_chans/css/style_ebay.css">
...
<div class="container-fluid dashboard-section p-4 my-4">
    ...
    <h2 class="text-dark-blue mb-4">Integrador / eBay</h2>
    <p class="lead">Seleccione una importación para migrar los datos del archivo de productos de eBay.</p>
    ...
    <div class="card p-4 shadow-sm">
        <div class="row align-items-end">
            ...
            <div class="col-md-4">
                <button id="btnIntegrarEbay" class="btn btn-primary w-100" disabled>
    ...
    <?php
        ...
        $num_registros = contarRegistrosEbayPorCorrelativo($correlativo_usado, $link);
    ?>
    <div class="card mt-4 shadow-sm">
        <div class="card-header bg-dark text-white">
            <h5 class="mb-0">Última Integración Realizada (eBay)</h5>
        </div>
        <div class="card-body">
            <div class="d-flex justify-content-between align-items-center flex-wrap">
                ...
                <div class="d-flex gap-2 mt-2 mt-md-0">
                    <button id="btnVerDatosEbay" class="btn btn-info" data-correlativo="<?php echo htmlspecialchars($correlativo_usado); ?>">
                        <i class="fas fa-eye me-2"></i>Ver Datos
                    </button>
                    <button id="btnVaciarEbay" class="btn btn-danger">
...
<script src="/ec_chans/js/script_ebay.js"></script>
