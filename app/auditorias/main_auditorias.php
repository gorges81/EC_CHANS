<?php
// /ec_chans/app/auditorias/main_auditorias.php
...
<div class="container-fluid dashboard-section p-4 my-4">
    <h2 class="mb-4 text-dark-blue">Módulo de Auditorías (En Construcción)</h2>
    <p class="lead">Aquí podrás revisar los registros de auditoría del sistema.</p>
